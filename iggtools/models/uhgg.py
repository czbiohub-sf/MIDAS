...
def get_uhgg_layout(species_id, component="", genome_id=""):
    return {
        ...
        "marker_centroids_99":         f"marker_genes/{inputs.marker_set}/marker_centroids_99/{species_id}.txt",
    ...
    def fetch_files(self, filetype, list_of_species_ids=""):
        ...
        if list_of_species_ids:
            for species_id in list_of_species_ids:
                ...
                if filetype == "marker_centroids_99":
                    s3_file = self.get_target_layout("marker_centroids_99", True, "", species_id)
                    dest_file = self.get_target_layout("marker_centroids_99", False, "", species_id)
