...
from midas2.common.utils import tsprint, InputStream, OutputStream, command, hashmap, multithreading_hashmap, multithreading_map, select_from_tsv, pythonpath, num_physical_cores, copy, copy_star, flatten
from midas2.common.utilities import decode_species_arg, check_worker_subdir
from midas2.models.midasdb import MIDAS_DB
from midas2.params.inputs import MIDASDB_NAMES
from midas2.subcommands.build_pangenome import vsearch, parse_uclust, CLUSTERING_PERCENTS, read_uclust_info, write_gene_info, localpath
...
def recluster_centroid_master(args):
    ...
    def species_work(species_id):
        ...
        with CONCURRENT_SPECIES_BUILDS:
            ...
            command(f"mkdir -p {worker_subdir}/temp")
...
def recluster_centroid_worker(args):
    ...
    assert os.path.isfile("cdhit/centroids.99.ffn"), f"Error: need to run recluster pipeline."
    assert os.path.isfile("cdhit/gene_info.txt"), f"Error: need to run recluster pipeline."
